...
public class RenderingUtil
{
    ...
    public static void drawMovedSquare(int mouseX, int mouseY, String logoLocation, boolean move) {
        ScaledResolution scale = new ScaledResolution(Minecraft.getMinecraft(),
                Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
        if (move == true) {
            Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(logoLocation));
            ...
            Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(logoLocation));
            Gui.drawModalRectWithCustomSizedTexture(scale.getScaledWidth() / 2 - 90, scale.getScaledHeight() / 2 - 80, 1, 1, 160, 160, 160, 160);
        }
    }
    ...
    public static int getIntFromColor(int r, int g, int b) {
        r = (r << 16) & 0x00FF0000; // Shift red 16-bits and mask out other
        // stuff
        g = (g << 8) & 0x0000FF00; // Shift Green 8-bits and mask out other
        // stuff
        b = b & 0x000000FF; // Mask out anything not blue.

        return 0xFF000000 | r | g | b; // 0xFF000000 for 100% Alpha. Bitwise
