...
public class ColorUtil {
    ...
    public static Color getHealthColor(EntityLivingBase entityLivingBase) {
        ...
        return health >= 0.0f ? blend(fractions, colors, progress).brighter() : colors[0];
    }
    ...
    public static Color getHealthColor(float health, float maxHealth) {
        ...
        return blend(fractions, colors, progress).brighter();
    }
    ...
    public static Color blend(float[] fractions, Color[] colors, float progress) {
