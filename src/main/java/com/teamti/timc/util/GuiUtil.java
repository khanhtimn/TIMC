...
extends Gui {
	public void drawOutlineRect(float drawX, float drawY, float drawWidth, float drawHeight, int color) {
        GuiUtil.drawRect(drawX-0.4, drawY - 0.4f, drawWidth -7.8, drawY + 0.5f, color);
        GuiUtil.drawRect(drawX-0.4, drawY + 0.5f, drawX + 0.5f, drawHeight + drawY/2 - 7.4, color);
        GuiUtil.drawRect(drawWidth - 0.5f, drawY-drawY/1.5 + 0.5f + 3.43, drawWidth + 0.4f, drawHeight - 0.5f, color);
        GuiUtil.drawRect(drawX + 0.3f + 7.5, drawHeight - 0.5f, drawWidth + 0.4f, drawHeight+0.4f, color);
    }
    ...
    public void drawOutlinedRect(float drawX, float drawY, float drawWidth, float drawHeight, float alpha, float red, float green, float blue) {
        GuiUtil.drawRectColor(drawX, drawY, drawWidth -8, drawY + 0.5f, alpha, red, green, blue);
        GuiUtil.drawRectColor(drawX, drawY + 0.5f, drawX + 0.5f, drawHeight + drawY/2 - 7.5, alpha, red, green, blue);
        GuiUtil.drawRectColor(drawWidth - 0.5f, drawY-drawY/1.5 + 0.5f + 3.5, drawWidth, drawHeight - 0.5f, alpha, red, green, blue);
        GuiUtil.drawRectColor(drawX + 0.5f + 7.5, drawHeight - 0.5f, drawWidth, drawHeight, alpha, red, green, blue);
    }
    ...
    public static void drawRoundedRect(float x2, float y2, float maxX, float maxY, int color) {
        GuiUtil.drawRect(x2 + 0.5f, y2, maxX - 0.5f, y2 + 0.5f, color);
        GuiUtil.drawRect(x2 + 0.5f, maxY - 0.5f, maxX - 0.5f, maxY, color);
        GuiUtil.drawRect(x2, y2 + 0.5f, maxX, maxY - 0.5f, color);
    }
    ...
    public void drawFilledBBESP(AxisAlignedBB axisalignedbb, int color) {
        ...
        GL11.glDepthMask(false);
        GL11.glColor4f(red, green, blue, alpha);
        GuiUtil.drawFilledBox(axisalignedbb);
        GL11.glDisable(2848);
        GL11.glEnable(3553);
        GL11.glEnable(2896);
        GL11.glEnable(2929);
    ...
    public void drawBoundingBoxESP(AxisAlignedBB axisalignedbb, float width, int color) {
        ...
        GL11.glColor4f(red, green, blue, alpha);
        GuiUtil.drawOutlinedBox(axisalignedbb);
    ...
    public void draw2DPlayerESP(EntityPlayer ep2, double d2, double d1, double d22) {
        ...
        float distance = TIMC.core.player().getDistanceToEntity(ep2);
        Minecraft.getMinecraft();
        float scale = (float)(0.09 + TIMC.core.player().getDistance(ep2.posX, ep2.posY, ep2.posZ) / 10000.0);
        GL11.glPushMatrix();
