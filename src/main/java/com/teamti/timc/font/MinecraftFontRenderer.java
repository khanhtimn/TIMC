...
extends CFont {
    ...
    public float drawString(String text, double x2, double y2, int color, boolean shadow, float kerning) {
        ...
        boolean render = true;
        x2 *= 2.0 * TIMC.fontScaleOffset;
        y2 = (y2 - 3.0) * 2.0 * TIMC.fontScaleOffset;
        GL11.glPushMatrix();
        GlStateManager.scale(0.5 / TIMC.fontScaleOffset, 0.5 / TIMC.fontScaleOffset, 0.5 / TIMC.fontScaleOffset);
    ...
    public double getStringWidth(String text) {
        ...
        return width / (2 * TIMC.fontScaleOffset);
    }
    ...
    public int getHeight() {
        return (this.fontHeight - (int)(8* TIMC.fontScaleOffset)) / (int)(2 * TIMC.fontScaleOffset);
    }
