...
public class OpenBookCrasher4 extends Module {

    public static boolean isEnabled;
    public static double packets = 10.0;
    public OpenBookCrasher4() {
        super("OpenBookCrasher4", Keyboard.KEY_NONE);
    ...
    public void onUpdate() {
        ItemStack stack123 = new ItemStack(Items.writable_book);
