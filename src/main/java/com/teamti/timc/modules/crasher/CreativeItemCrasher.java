...
public class CreativeItemCrasher extends Module {

    private int time = 0;
    public static boolean isEnabled;

    public CreativeItemCrasher() {
        super("CreativeItem", Keyboard.KEY_NONE);
    ...
    public void onUpdate() {
        if (isEnabled) {
            ...
            CrasherUtil.INSTANCE.CreativeCrasher_GiveBook();
