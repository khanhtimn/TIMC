package com.teamti.timc.modules.crasher.acc;
...
public class AutoCompleteCrasher3 extends Module {

    public static boolean isEnabled;
    public static double packets = 10.0;

    public AutoCompleteCrasher3() {
        super("Tab Complete", Keyboard.KEY_NONE);
