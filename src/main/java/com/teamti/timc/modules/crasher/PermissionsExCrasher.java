...
public class PermissionsExCrasher extends Module {
    ...
    public PermissionsExCrasher() {
        super("PermissionsExCrasher", Keyboard.KEY_NONE);
    ...
    public void onUpdate() {
        if (isEnabled) {
            ...
            CrasherUtil.INSTANCE.PermissionsExCrasher();
