package com.teamti.timc.modules.crasher.lbc;
...
public class LabySpammerCrasher extends Module {

    public static boolean isEnabled;

    public LabySpammerCrasher() {
        super("LabySpammerCrasher", Keyboard.KEY_NONE);
