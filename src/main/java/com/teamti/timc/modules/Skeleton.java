...
public class Skeleton extends Module {
    ...
    public static BooleanValue smoothLines;
    public static boolean isEnabled;
    private final Map playerRotationMap = new WeakHashMap();


	public Skeleton() {
        super("Skeleton", Keyboard.KEY_NONE);
        this.jelloCat = TIMC.tabgui.cats.get(4);
        smoothLines = new BooleanValue("Smooth Lines", true);
        addValue(smoothLines);
    }
    ...
    @EventTarget
    public final void onRender(EventRender3D event) {
