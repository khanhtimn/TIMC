...
import com.teamti.timc.modules.KillAura;
import com.teamti.timc.modules.OldSneak;
import com.teamti.timc.util.OldSneakUtil;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public float getEyeHeight()
    {
        ...
        if (OldSneak.isEnabled && Minecraft.getMinecraft().thePlayer != null && this.equals(Minecraft.getMinecraft().thePlayer) && Minecraft.getMinecraft().gameSettings.thirdPersonView == 0)
        {
            var1 = OldSneakUtil.getCustomEyeHeight(this);
        }
