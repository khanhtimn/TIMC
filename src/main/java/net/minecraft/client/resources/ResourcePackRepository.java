...
public class ResourcePackRepository {
     ...
     */
    public ListenableFuture<Object> downloadResourcePack(String url, String hash) throws IOException {
        ...
        try {
            ...
            this.downloadingPacks = HttpUtil.func_180192_a(file1, url, map, 0x3200000, guiscreenworking, minecraft.getProxy());
    ...
    public void clearResourcePack() {
        ...
        try {
            ...
            if (this.resourcePackInstance != null) {
                ...
                Minecraft.getMinecraft().func_175603_A();
            }
        }
        finally {
            this.lock.unlock();
