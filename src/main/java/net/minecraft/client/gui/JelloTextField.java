...
public class JelloTextField extends GuiTextField
{
    ...
    public void drawTextBox(int mouseX, int mouseY)
    {
        if (this.getVisible())
        {
    		...
    		float outro = smoothTrans(TIMC.jgui.outro, TIMC.jgui.lastOutro);
        	...
        	boolean isInClickGUI = Minecraft.getMinecraft().currentScreen instanceof TIMCGui || Minecraft.getMinecraft().currentScreen == null;
