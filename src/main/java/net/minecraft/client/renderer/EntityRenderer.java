...
import com.teamti.timc.modules.CameraClip;
        ...
        else
        {
            ...
            if(!zoomActive){
            	if(zoomDist > 1){
            		//zoomDist = 1;
                    //TODO: optifine zoom
            		zoomDist += ((1-zoomDist)/(60*mc.getDebugFps()*0.01))-0.000001;
            		zoomDist += ((1-zoomDist)/(60*mc.getDebugFps()*0.01))-0.000001;
            		//0.04
            	}
            }
            ...
            if (zoomActive)
            {
                ...
                if (Config.zoomMode)
                {
                	if(zoomDist < 4){
                		//zoomDist += 0.01;
                		zoomDist += (((4)-zoomDist)/(120*mc.getDebugFps()*0.005))+0.001;
                		//0.000001
                	}
    ...
    public void orientCamera(float p_78467_1_)
    {
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                //GlStateManager.translate(0.0F, 0.0F, (float)(-var28));
                //TODO: perspective 3 transform
                GlStateManager.translate(0.0F, Minecraft.getMinecraft().gameSettings.thirdPersonView == 3 ? -0.2F : 0.0f, Minecraft.getMinecraft().gameSettings.thirdPersonView == 3 ? 0.2f : (float) (-var28));
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    if(mc.currentScreen == null && TIMC.jgui.outro < 1.7 && mc.thePlayer != null && mc.thePlayer.ticksExisted > 1 && TIMC.jgui.outro >= 1){
                    	TIMC.jgui.drawScreen(0, 0, partialTicks);
                    }
