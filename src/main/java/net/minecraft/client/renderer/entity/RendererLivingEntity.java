...
import com.teamti.timc.modules.AntiInvis;
import com.teamti.timc.modules.ESP;
import com.teamti.timc.util.LeftHandUtil;
import com.teamti.timc.util.OutlineRenderer;
...
public abstract class RendererLivingEntity extends Render {
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        if(ESP.isEnabled && ESP.isCorrect(p_76986_1_) && ESP.wallhack.getValue()){
...
//			}
            ...
            if (ESP.isEnabled && ESP.outline.getValue()) {
                if (ESP.isCorrect(p_76986_1_) && !p_76986_1_.getName().startsWith("Body #")) {
                    renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
                    OutlineRenderer.renderOneEntity();
                    renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
                    OutlineRenderer.renderTwo();
                    renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
                    OutlineRenderer.renderThree();
                    OutlineRenderer.renderFour(p_76986_1_);
                    renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
                    OutlineRenderer.renderFive();
                }
            }
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        boolean var8 = AntiInvis.isEnabled ? true : !p_77036_1_.isInvisible();
        ...
        if (var8 || var9) {
            ...
            /*
            if (ESP.isEnabled && ESP.chams.getValue() && ESP.isCorrect(p_77036_1_)) {
                GL11.glPushMatrix();
                ...
                GL11.glLineWidth(3);
                OutlineRenderer.getColors(p_77036_1_);
    ...
    protected void func_177093_a(EntityLivingBase p_177093_1_, float p_177093_2_, float p_177093_3_, float p_177093_4_, float p_177093_5_, float p_177093_6_, float p_177093_7_, float p_177093_8_) {
        ...
        while (var9.hasNext()) {
            ...
            //TODO: Left Hand
            if (LeftHandUtil.use((Entity)p_177093_1_) && var10 instanceof LayerCape)
            {
                GlStateManager.scale(-1.0F, 1.0F, 1.0F);
            }
