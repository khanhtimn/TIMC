...
import com.teamti.timc.util.ItemPhysicsUtil;
...
public class RenderEntityItem extends Render
{
    ...
    {
        if(TIMC.getModule("ItemPhysics").isToggled()) {
            ItemPhysicsUtil.doRender(p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
        }
